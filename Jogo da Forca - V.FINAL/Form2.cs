...
namespace Jogo_da_Forca___V.FINAL
{
    public partial class Form2 : Form
    {
        ...
        private void pROFISSIONALToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void btn_guardaDados_Click(object sender, EventArgs e)
        {
            ...
            {
                FileInfo highscoreAmador = new FileInfo(@"highscores_amador.txt");
        ...
        private void sortearPalavra()
        {
            ...
            ptb_bracoEsquerdo.Visible = false;
            ptb_bracoDireito.Visible = false;
