...
namespace Jogo_da_Forca___V.FINAL
{
    public partial class Form4 : Form
    {
        ...
        public Form4()
        {
            InitializeComponent();
            palavrasGuardadas();
            MessageBox.Show("NESTE NÍVEL INTERMÉDIO TEM DE ADIVINHAR A PALAVRA MAS APENAS PODE DAR 3 ERROS...", "INFORMAÇÃO", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btn_guardaDados_Click(object sender, EventArgs e)
        {
            ...
            {
                FileInfo highscoreAmador = new FileInfo(@"highscores_intermedio.txt");
        ...
        private void sortearPalavra()
        {
            ...
            ptb_corpo.Visible = false;
            ptb_pernaEsquerda.Visible = false;
            ptb_pernaDireita.Visible = false;
